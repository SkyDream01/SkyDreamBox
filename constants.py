...
PROCESS_START_TIMEOUT_MS = 3000  # 子进程启动等待超时（毫秒）
...
AUDIO_CODECS_FOR_VIDEO_FORMAT = {
    "mp4": ["aac", "libmp3lame", "alac", "copy"],
    "mkv": ["aac", "libmp3lame", "flac", "libopus", "copy"],
    "avi": ["libmp3lame", "aac"],
    "mov": ["aac", "libmp3lame", "alac", "copy"],
...
RESOLUTION_PRESETS = {"720p": 1280, "1080p": 1920, "2k": 2560, "4k": 3840}

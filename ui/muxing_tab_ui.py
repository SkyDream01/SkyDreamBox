...
class Ui_MuxingTab:
    def setupUi(self, MuxingTab):
        ...
        self.select_video_button.setIcon(MuxingTab.style().standardIcon(QStyle.StandardPixmap.SP_DirOpenIcon))
        ...
        self.select_audio_button.setIcon(MuxingTab.style().standardIcon(QStyle.StandardPixmap.SP_DirOpenIcon))
        ...
        self.select_subtitle_button.setIcon(MuxingTab.style().standardIcon(QStyle.StandardPixmap.SP_FileIcon))
        ...
        self.select_output_button.setIcon(MuxingTab.style().standardIcon(QStyle.StandardPixmap.SP_DriveFDIcon))
